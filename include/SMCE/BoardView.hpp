...
class SMCE_API FrameBuffer {
  ...
  public:
    ...
    /// Copies a frame from a packed buffer of pixels in the format RRRRGGGGGGGBBBB
    bool write_rgb565(std::span<const std::byte>);
    /// Copies a frame into a packed buffer of pixels in the format RRRRGGGGGGGBBBB
